  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <p className="mt-3 text-slate-400">{project.overview}</p>
        ...
        <div className="mt-6 flex gap-3">
          ...
          <button
            onClick={onOpen}
            className="ml-auto flex items-center gap-2 rounded-xl bg-cyan-500 px-4 py-2 font-semibold text-black transition hover:bg-cyan-400"
          >
            Details
            <ArrowRight size={18} />
          </button>
